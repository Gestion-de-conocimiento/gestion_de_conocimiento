    ...
    function rename_node() {
      ...
      var longitud = 90; //Longitud del nuevo nombre del tema en nodo
      if (name == "" || name.length > longitud || primer_char == '1' || primer_char == '2' || primer_char == '3' || primer_char == '4' || primer_char == '5' || primer_char == '6' || primer_char == '7' || primer_char == '8' || primer_char == '8' || primer_char == '9' || primer_char == '0') {
    ...
    async function saveNewName(node_to_rename) {
      await axios({
        method: 'post',
        url: "http://159.223.138.118/tema/editarNodo/" + node_to_rename.id + "?id_nodo=" + node_to_rename.id + "&nombre_nodo=" + node_to_rename.name + "&textPosition=" + node_to_rename.textPosition,
        headers: {
    ...
    function registerParentConection(parent, child, color) {
      axios({
        method: 'post',
        url: "http://159.223.138.118/tema/addsecundario?id_padre=" + parent.id + "&id_hijo=" + child.id + "&color=" + color,
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
        data: {
    ...
    async function deleteParentDB(child, parent, tipo) {
      ...
      await axios({
        method: 'post',
        url: "http://159.223.138.118/tema/deleteNodoSecundario?id_hijo=" + child + "&id_padre=" + parent + "&tipo=" + tipo_numerico,
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
        data: {
        ...
        //location.reload();
        window.location.href = "http://159.223.138.118/grafo";
      }).catch(function(error) {
        console.log('Error: ' + error)
      })
    }
    ...
    function create_node() {
      ...
      var primer_char = name.charAt(0);
      var longitud = 90; //Longitud de caracteres para el nombre del nodo

      if (name == "" || name.length > longitud || primer_char == '1' || primer_char == '2' || primer_char == '3' || primer_char == '4' || primer_char == '5' || primer_char == '6' || primer_char == '7' || primer_char == '8' || primer_char == '8' || primer_char == '9' || primer_char == '0') {
        $('#mensaje_4').text("Por favor ingresa un nombre valido, el nombre no debe empezar con número ni tener más de 90 caracteres.")
      } else {
    ...
    function hacerHijoPadre(oldParent, newChildParent) {
      axios({
        method: 'post',
        url: "http://159.223.138.118/tema/hacerHijoPadre/" + oldParent.id + "?id=" + oldParent.id + "&id2=" + newChildParent.id,
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
        data: {
    ...
    function cambiarPadre(nodeToChange, newParent) {
      axios({
        method: 'post',
        url: "http://159.223.138.118/tema/cambiarPadre/" + nodeToChange.id + "?id=" + nodeToChange.id + "&id2=" + newParent.id,
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
        data: {
    ...
    function actualizarPadre(oldParent, newParent, children, color) {
      axios({
        method: 'post',
        url: "http://159.223.138.118/tema/cambiarPadre/" + oldParent + "?id=" + oldParent + "&id2=" + newParent + "&hijo=" + children + "&color=" + color,
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
        data: {
    ...
    function deleteandcambiarPadre(oldParent, newParent) {
      axios({
        method: 'post',
        url: "http://159.223.138.118/tema/deleteandcambiarPadre/" + oldParent.id + "?id=" + oldParent.id + "&id2=" + newParent.id,
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
        data: {
    ...
    function deleteAllSons(idNode) {
      ...
      axios({
        method: 'post',
        url: "http://159.223.138.118/tema/deleteTema1/" + idNode + "?id=" + idNode,
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
        data: {
    ...
    async function updatePosition(draggingNode) {
      await axios({
        method: 'post',
        url: "http://159.223.138.118/tema/posicion?newx=" + draggingNode.freex + "&newy=" + draggingNode.freey + "&id=" + draggingNode.id,
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
        data: {
    ...
    async function createRequestNewNode(new_node) {
      ...
      await axios({
        method: 'post',
        url: "http://159.223.138.118/tema/addTema?nombre_tema=" + new_node.name + "&nivel_tema=" + (create_node_parent.level2 + 1) + "&id_padre=" + create_node_parent.id +
    ...
    async function getTreeFromBD() {
      ...
      await axios({
        method: 'get',
        url: "http://159.223.138.118/temas/arbol",
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
      }).then(function(response) {
    ...
    function listarNodos(d) {
      ...
      axios({
        method: 'get',
        url: "http://159.223.138.118/temas/posiblesNodosPadres/" + d.level2,
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
      }).then(function(response) {
        ...
        axios({
          method: 'get',
          url: "http://159.223.138.118/temas/obtenerPadres/" + d.id,
          headers: {
            'content-type': 'application/x-www-form-urlencoded'
          },
        }).then(function(response) {
    ...
    function listarNodosPadre(d) {
      ...
      axios({
        method: 'get',
        url: "http://159.223.138.118/obtenerConexiones/" + d.id,
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
      }).then(function(response) {
    ...
    async function obtenerColoresRelaciones() {
      ...
      await axios({
        method: 'get',
        url: "http://159.223.138.118/tema/relacionesPrimarias",
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
      }).then(function(response) {
    ...
    async function guardarNuevoColor() {
      ...
      await axios({
        method: 'post',
        url: "http://159.223.138.118/tema/actualizarColor?id=" + id_conexion + "&color=" + nuevo_color,
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
        data: {
    ...
    async function updateSizeNode() {
      ...
      await axios({
        method: 'post',
        url: "http://159.223.138.118/tema/actualizarRadio/" + ratio,
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
        data: {
    ...
    async function getSizeNode() {
      ...
      await axios({
        method: 'get',
        url: "http://159.223.138.118/tema/obtenerRadio",
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
      }).then(function(response) {
    ...
    function loadQuestions(d) {
      ...
      axios({
        method: 'get',
        url: "http://159.223.138.118/preguntas/nodo?id=" + id_tema,
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
      }).then(function(response) {
    ...
    async function cambioInput(id) {
      ...
      if (id == "inp_bueno") {
        ...
        console.log(total_bueno)
        if (total_bueno == 0) {

          console.log("Ingresa numero mayor a 0")
          document.getElementById("msg_cero").innerHTML = "Ingrese número mayor a 0"
          document.getElementById("msg_cero").style.color = "red";
          document.getElementById("btn_guardar_porcentajes").disabled = true;
          bandera = true;
        } else {
          document.getElementById("msg_cero").innerHTML = ""
          bandera = false;
        }
      ...
      document.getElementById("lbl_total_porcentaje").innerHTML = total
       ...
       if (total != 100 ) {
        ...
        document.getElementById("btn_guardar_porcentajes").disabled = true;
      } else if (bandera == true || bandera2 == true || bandera3==true) {
        document.getElementById("btn_guardar_porcentajes").disabled = true;
        document.getElementById("msg_cero").innerHTML = "Ingrese número mayor a 0"
        document.getElementById("msg_cero").style.color = "red";
    ...
    async function guardarPorcentajes() {
      ...
      if (porcentaje_total == 100) {
        ...
        await axios({
          method: 'post',
          url: "http://159.223.138.118/temas/guardarProbabilidades",
          data: {
            bueno: total_bueno,
    ...
    async function siguienteNodoNoRegistrado() {
      axios({
        method: 'get',
        url: "http://159.223.138.118/preguntas/nodo?id=" + nodos_ordenados[numero_nodo_ordenado],
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
      }).then(function(response) {
    ...
    async function obtenerEvidenciaExpertos() {
      ...
      await axios({
        method: 'get',
        url: "http://159.223.138.118/obtenerEvidencias",
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
      }).then(function(response) {
    ...
    async function comenzarRegistroEvidencia() {
      resetearFormulario();
      await loadQuestions({
        id: nodos_ordenados[numero_nodo_ordenado]
      });
    }
    ...
    async function obtenerTotalTemas() {
      ...
      await axios({
        method: 'get',
        url: "http://159.223.138.118/obtenerTotalTemas",
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
      }).then(function(response) {
    ...
    async function obtenerCaminos() {
      ...
      await axios({
        method: 'get',
        url: "http://159.223.138.118/arbol/caminos",
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
      }).then(function(response) {
    ...
    async function obtenerRamas() {
      ...
      await axios({
        method: 'get',
        url: "http://159.223.138.118/arbol/obtenerRamas",
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
      }).then(function(response) {
    ...
    async function changeParent() {
      ...
      window.location.href = "http://159.223.138.118/historialexperto?x=" + x_init + "&y=" + y_init + "&e=" + e_init;
    }
    ...
    async function saludarDesdeGrafoNodos(){
      console.log("Saludos desde la vista de grafo de alumnos");
    }


    async function obtenerPoderacionesNodos() 
   {
      ...
      await axios({
        method: 'get',
        url: "http://159.223.138.118/arbol/poderacionesNodos",
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
      }).then(function(response) {
    ...
    async function obtenerRA() 
   {
      var ramas = []
      await axios({
        method: 'get',
        url: "http://159.223.138.118/arbol/obtenerRA",
        headers: {
          'content-type': 'application/x-www-form-urlencoded'
        },
      }).then(function(response) {
