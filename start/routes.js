...
// Rutas para la Interfaz Temas No Dominados
//Route.get('/api/temas-no-dominados', 'VistaGeneralCont.getTemas').middleware(['auth']);
...
// Route.get('/recurso/obtenerTemasPorRama', 'RecursoController.obtenerTemasPorRama');
 // Route.get('/api/temas-no-dominados', 'VistaGeneralCont.getTemas')
...
Route.group(()=>{
  ...
  Route.get('/recrusosvistaespecial/mostrarrecursosvistaespecial', 'ControladorRecursosEnsenanza.mostrarTemasPorRama')
